...
DecodeCfgValues = function () {
    ...
    /*
    console.log(hashValues[2]);
    console.log(hashValues[3]);
    blah = Base62.decode(hashValues[2]).toString(2);
    blah += Base62.decode(hashValues[3]).toString(2);
    console.log(parseInt(blah.substring(16, 25), 2));
    //*/
    ///*

    //console.log(inputBits.length);

    // Gather all bits for the input data - 377 in total
    ...
    //console.log("rangebitString Length before padding: " + rangeBitString.length);
    // pad with zeroes up to total length of all the input range values
    while (rangeBitString.length < inputBitTotal) { rangeBitString = "0" + rangeBitString; }
    //console.log("rangebitString Length: " + rangeBitString.length);
    //console.log(rangeBitString);
